...
- starsandstraps {{{ •.  «    clerical note\addition to the text\file{{{
    - alexander\s (bug juice, disney) aim screenhandle
        - page 5 §2001, PoI doc, P-o-I repo (https://github.com/satoshiofficial/Proof-of-IdentityComplementary/blob/f17ef352a7bce965ad2c8cdcdb2f425cfc6e1c90/notes.pdf), ]personal[), AIM screenname (as far as The Author can recall)
         > - brockwtc13 (week of 9-11-2001)
         >     - Only messaged one account: Alexander, "Bug Juice" whose screen-name was verified on Disney's website; long story; more info to be added later)
         >     - Talked about attacks; almost-rhetorically asked, "Who is going to pay for all those computers they destroyed?"
...
> This is going to be A LOT in a world where everyone can write whatever statistics or ML model they want via AI coding tools but not everyone can think through evidence design
...
- Added original, typewritten outline to Discussion Paper repo
    - https://github.com/satoshiofficial/btc/blob/main/IMG_6985.JPEG
...
- List of angel investors potentially contacting:
    - https://docs.google.com/document/d/1shJ0Um5qYvrpGwyQ8ftsVJuS0_eXQ08FpOxS9lBfe04/edit?usp=drivesdk
- Crunchbase profile being created today
...
- This is just an observation but, the doors in Sterling Cooper, throughout Season 1 and 2 of Mad Men, the color of the doors (a light blue/turquoise?), are beautiful
    ...
    - https://midcenturymodernist.com/2010/culture/film-tv/mad-men-furniture-don-drapers-office/
...
- Copied from Gemini iOS app (w/ a freshly-minted (note on the text: Google Founders now can kind of be said to be Masters of Fine Arts somewhat in a way in terms of, now hear me out, because this is important:  understanding that users, and the Market(s), or, translate-that-however-you\d-like, before 2025\s oddly-accepted-in-real-time-,almost-by-multiple-Nations/NationStates, looking-back-at…]2049].
-
- ľp
