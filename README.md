A research, manufacturing and development ventures company, focusing on digital assets and web5, with an organizational structure to be located in the American States of Washington (Ventures, R&D), Wyoming (Manufacturing) and the two 'Blockchain States,’ Louisiana (Manufacturing, Legal) and Texas (HQ). Forward-looking statements not meant as securities of any kind.
