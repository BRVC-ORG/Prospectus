...
- One thing that people new to crypto or aren't familiar with cryptography: the time that it takes for cryptographers or developers to become even basically familiar with a coin or chain like Bitcoin or Ethereum: you cannot take that away from them and it's kind of hard to grasp, at least as of right now
